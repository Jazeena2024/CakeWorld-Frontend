        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredProducts.map((product, index) => (
              <div
                key={product.id}
                className="group bg-soft-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 animate-fade-in-up"
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="px-6 py-3 bg-terracotta hover:bg-terracotta/90 text-white rounded-full font-medium shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105">
                      Add to Cart
                    </button>
                  </div>
                </div>
      ...
      <section className="py-20 bg-gradient-to-r from-terracotta via-rose to-peach relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/95 mb-8 max-w-3xl mx-auto">
            Get 20% off on all wedding cake orders this season. Plus, free delivery for orders over $100!
          </p>
          <button className="px-10 py-5 bg-white text-terracotta rounded-full font-bold shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 text-lg">
            Claim Your Discount
          </button>
